...
{
    // DRAW THE LEFT PANEL
    drawPanel(0,0,150,768, Qt::red,1);

    //draw right panel
    drawPanel(874,0,150,768,Qt::red,1);
...
{
    //create title text
    QGraphicsTextItem* titleText = new QGraphicsTextItem(QString("Color Game Box"));
    ...
    //play button
    intro* playButton = new intro(QString("PLAY"));
    ...
    //quit button
    intro* quitButton = new intro(QString("QUIT"));
...
void Game::displayGameOverWindow(QString textToDisplay){
    ...
    intro* playAgain = new intro(QString("Play Again"));
    playAgain->setPos(410,300);
    scene->addItem(playAgain);
    connect(playAgain,SIGNAL(clicked()),this,SLOT(restartGame()));

    // create quit button
    intro* quit = new intro(QString("Quit"));
    quit->setPos(410,375);
    scene->addItem(quit);
